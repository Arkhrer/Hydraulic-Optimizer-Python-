...
class epanet:
    ...
    def __init__(self, *argv, version=2.2, loadfile=False, verbose=True, multithreading=False):
        # Constants
        ...
        if len(argv) > 0:
            ...
            if len(argv) == 1:
                ...
                if self.multithreading:
                    self.TempInpFile = self.InputFile[0:-4] + '_temp_' + str(threading.current_thread().ident) + '.inp'
                else:
                ...
                # Load temporary file
                if self.multithreading:
                    rptfile = self.InputFile[0:-4] + '_temp_' + str(threading.current_thread().ident) + '.txt'
                    binfile = self.InputFile[0:-4] + '_temp_' + str(threading.current_thread().ident) + '.bin'
                else:
                ...
                # Save the temporary input file
                if self.multithreading:
                    self.BinTempfile = f'{self.InputFile[0:-4]}_temp_{str(threading.current_thread().ident)}.inp'
                else:
